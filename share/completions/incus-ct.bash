#!/bin/bash
# Bash completion for incus-ct script
...
_incus_ct_completion() {
    ...
    case "$command" in
    create)
        # For 'incus-ct create', second argument is distro, third is optional name
...
complete -F _incus_ct_completion incus-ct
