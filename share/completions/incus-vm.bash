#!/bin/bash
# Bash completion for incus-vm script
...
_incus_vm_completion() {
    ...
    case "$command" in
    create)
        # For 'incus-vm create', second argument is distro, third is optional name
...
complete -F _incus_vm_completion incus-vm
